...
# Avoid reusing dead/stale DB sockets
# (common with hosted Postgres idle timeouts).
...
# or "login" if using django.contrib.auth
LOGIN_URL = reverse_lazy("account_login")
LOGIN_REDIRECT_URL = reverse_lazy(
    "showroom:car_list")    # where to land after login
