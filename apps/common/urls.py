...
from .views import (
    ...
    NewsletterEmailListView, NewsletterEmailCreateView, NewsletterEmailUpdateView,
...
urlpatterns = [
    ...
    path("newsletter-email/",                  NewsletterEmailListView.as_view(),   name="newsletter_email_list"),
    path("newsletter-email/create/",           NewsletterEmailCreateView.as_view(), name="newsletter_email_create"),
    path("newsletter-email/<int:pk>/edit/",   NewsletterEmailUpdateView.as_view(), name="newsletter_email_edit"),
    path("newsletter-email/<int:pk>/delete/", NewsletterEmailDeleteView.as_view(), name="newsletter_email_delete"),
    path("newsletter-email/<int:pk>/send/",   NewsletterEmailSendView.as_view(),   name="newsletter_email_send"),
